...
$array_page_sel_langue = array('fr' => 13);
...
$seo['upline'] = $seo['title'] = 'Visites Virtuelles | Maisons Kerbea';
...
$breadcrumbs = $_SESSION['agence']['session'] ? '<a href="' . RESSOURCE_URL . '/agence-' . $_SESSION['agence']['alias'] . '">Maisons Kerbéa ' . $_SESSION['agence']['alias'] . '</a><img src="' . RESSOURCE_URL . '/images/pictos/fl-r-red.png" alt=""/>visites virtuelles ' : '<a href="' . RESSOURCE_URL . '">Maisons Kerbéa</a><img src="' . RESSOURCE_URL . '/images/pictos/fl-r-red.png" alt=""/>visites virtuelles';
...
<head>
  ...
  <meta property="og:image"
        content="<?php echo RESSOURCE_URL . '/medias/modele_maison/galerie/grande/' . $ogimg['image1_modele_maison']; ?>"/>
...
<div id="container-content">
  ...
  <div class="content-hover">
    ...
    <div class="site-width relative">
      ...
      <h1 class="black-title">Visites virtuelles</h1>
      ...
      <div class="list two">
        ...
        <div class="items">
          <?php
            foreach ($select_modeles as $key => $modele_maison) {
              if(!checkVisiteVirtualAvaible($modele_maison['alias_modele_maison'])) {
                unset($select_modeles[$key]);
              }
            }
          $select_modeles = array_values($select_modeles);
            if (count($select_modeles)):
            ...
            foreach ($select_modeles as $modele_maison):
              ...
              $link = RESSOURCE_URL . '/visite360/maisons/'. $modele_maison['alias_modele_maison'] .'/index.html';
              ...
              if (!empty($count_variante_modele)) {
                ...
                foreach ($select_variante_modele as $variante) {
                  ...
                  if (in_array('étage', $array_spec)) {
                    $flt_etage = true;
                  }

                  if (in_array('combles aménagés', $array_spec)) {
                    $flt_combleA = true;
                  }

                  if (in_array('plain pied', $array_spec)) {
                    $flt_plainPied = true;
                  }

                  if (in_array('garage intégré', $array_spec)) {
                    $flt_garage = true;
                  }
              ...
              <div class="list-item<?php echo $type_item; ?>"<?php echo $html_generate_data; ?>>
                ...
                <div class="image">
                  ...
                  <?php echo createLink('<span class="bg-black modele"></span>', $link, '','blank'); ?>

                  <?php echo createLink('<img src="' . $image . '" alt=""/>', $link, '', 'blank'); ?>
                ...
                <div class="content">
                  ...
                  <?php echo createLink('+', $link, 'link', 'blank'); ?>
          ...
          <?php else: ?>
            Aucune visite virtuelle n'est disponible pour le moment.
          <?php endif; ?>
        </div>
      </div>
    </div>
