...
$array_menu_sel_langue = array('fr' => 27);$array_page_sel_langue = array('fr' => 2);
...
$seo['upline'] = $seo['title'] = 'Chantier | Maisons Kerbea';
...
$select_real = $PDO -> query('SELECT * FROM realisation WHERE actif_realisation = 1 AND type_realisation = "chantier" '.$where_agence);
?>
        ...
        <div id="container-content">
            ...
            <div class="content-hover">
                <div class="site-width relative">
                    ...
                    <h1 class="black-title">Chantier</h1>
                        ...
                        <div class="items">
                            <?php if($select_real -> rowCount()): $select_real = $select_real -> fetchAll(); ?>
                                ...
                                <?php foreach( $select_real as $realisation):
                                    ...
                                    $url_realisation = !empty($_SESSION['agence']['alias']) ? RESSOURCE_URL.'/agence-'.$_GET['alias'].'/chantier/'.rewrite_nom($realisation['nom_realisation']).'-'.$realisation['id_realisation'] : RESSOURCE_URL.'/chantier/'.rewrite_nom($realisation['nom_realisation']).'-'.$realisation['id_realisation'];
