...
$seo['upline'] = $seo['title'] = $line_realisation['nom_realisation'].' | Gamme '.strtoupper($line_realisation['nom_gamme']).' | Maisons Kerbea';
...
<html lang="fr-FR">
	<head>
        ...
        <meta property="og:description" content="<?php echo $line_realisation['description_realisation']; ?>" />
        <meta property="og:url" content="<?php echo 'https://'.$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI'];?>" />
        <meta property="og:image" content="<?php if(!empty($line_realisation['image1_realisation'])){echo RESSOURCE_URL.'/medias/realisation/galerie/grande/'.$line_realisation['image1_realisation'];} ?>" />
                                    ...
                                    <div id="slider_realisation_clip">
                                        ...
                                        for($i = 1; $i <= 8; $i++){
                                            if(!empty($line_realisation['image'.$i.'_realisation']))
                                                ...
                                                <a class="" data-lightbox="Images réalisation" href="'.RESSOURCE_URL.'/medias/realisation/galerie/grande/'.$line_realisation['image'.$i.'_realisation'].'">
